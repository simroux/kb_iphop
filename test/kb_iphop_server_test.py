...
from kb_iphop.kb_iphopImpl import kb_iphop
from kb_iphop.kb_iphopServer import MethodContext
from kb_iphop.authclient import KBaseAuth as _KBaseAuth

from installed_clients.AssemblyUtilClient import AssemblyUtil
from installed_clients.WorkspaceClient import Workspace


class kb_iphopTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('kb_iphop'):
        ...
        cls.serviceImpl = kb_iphop(cls.cfg)
    ...
    # NOTE: According to Python unittest naming rules test method names should start from 'test'. # noqa
    def test_run_kb_iphop_ok(self):
        # call your implementation
        ret = self.serviceImpl.run_kb_iphop(self.ctx,
    ...
    def test_run_kb_iphop_min_len_negative(self):
        with self.assertRaisesRegex(ValueError, 'min_length parameter cannot be negative'):
            self.serviceImpl.run_kb_iphop(self.ctx,
                                              {'workspace_name': self.wsName,
                                               'assembly_input_ref': '1/fake/3',
                                               'min_length': '-10'})

    def test_run_kb_iphop_min_len_parse(self):
